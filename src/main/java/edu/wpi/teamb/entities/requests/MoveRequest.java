...
public class MoveRequest extends RequestImpl {

    private Move move;
    //private Request request;

    public MoveRequest(int ID, String longName, Date date, String employee, String floor, String roomNumber,Date dateSubmitted, String requestStatus) {
