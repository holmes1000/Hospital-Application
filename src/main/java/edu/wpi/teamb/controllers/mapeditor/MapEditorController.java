...
//    this.edgeGroup = new Group();
    ...
    // Import white transparent pngs for menu buttons (size defined by resolution)
    ...
    btnMenuBackup.setGraphic(imageViewTools);
    btnMenuMove.setGraphic(imageViewMove);
    btnMenuTools.setGraphic(imageViewReset);
